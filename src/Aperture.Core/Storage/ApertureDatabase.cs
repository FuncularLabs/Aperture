...
/// <summary>
/// Owns the two SQLite files Aperture uses and hands out configured connections.
///
...
/// </summary>
public sealed class ApertureDatabase
{
    public const string MetadataFileName = "aperture.db";
